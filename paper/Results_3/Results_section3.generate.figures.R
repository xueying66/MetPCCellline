setwd('/home/liuxueying/Proj_MetPCCelline/paper/Results_3/')

# Figure.3a ---------------------------------------------------------------
load ('./data/CCLE.transcriptome.RData')
#pc.cell.line.name
...
load("./data/CCLE.rna.seq.marker.gene.1000.symbol.RData")
load ('./data/CCLE.transcriptome.RData')
...
ggsave('./plot/MET500.adenocarcinoma.pdf', plot = p1,width = 15, height = 10)
...
pdf(file  = './plot/bulk.site.specific.pdf',width=20,height=20)
...
pdf(file  = './plot/color.bar.pdf',width=20,height=20)
...
ggsave('./plot/scRNA-seq.Adenocarcinoma.pdf',width = 20,height=15 )
