...
load(file = '/home/liuxueying/Proj_MetPCCelline/output/MET.df.RData')
...
load(file = '/home/liuxueying/Proj_MetPCCelline/output/data/engineered.cell.line.RData')
load(file = '/home/liuxueying/Proj_MetPCCelline/output/data/CRPC.confident.seob.RData')
...
load( file = '/home/liuxueying/Proj_MetPCCelline/output/data/three.cell.type.seob.RData')
...
load(file = '/home/liuxueying/Proj_MetPCCelline/output/data/stem.organoid.ccle.RData')
load(file = '/home/liuxueying/Proj_MetPCCelline/output/data/stem.organoid.RData')
...
ggsave('/home/liuxueying/Proj_MetPCCelline/output/plot/organoid.pdf', width = 28, height = 12)
...
row_df <- cor.anno.matrix[,c('cor.max'), drop=F]
row_df <- as.data.frame(row_df)
